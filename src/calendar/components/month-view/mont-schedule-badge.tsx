...
import { DraggableSchedule } from "@/calendar/components/dnd/draggable-schedule";
...
export function MonthScheduleBadge({ schedule, cellDate, currentDay, totalDays, className, position: propPosition }: IProps) {
    ...
    const scheduleBadgeClasses = cn(scheduleBadgeVariants({ color, multiDayPosition: position, className }));
