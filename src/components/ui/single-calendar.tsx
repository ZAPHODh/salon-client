...
function SingleCalendar({ selected, ...props }: PropsSingle) {
    ...
    return (
        <DayPicker
            ...
            components={{
                PreviousMonthButton: ({ ...props }) => <Button {...props}><ChevronLeft className={cn("h-4 w-4")} /></Button>,
                NextMonthButton: ({ ...props }) => <Button {...props}><ChevronRight className={cn("h-4 w-4")} /></Button>,
            }}
            {...props}
        />
    );
